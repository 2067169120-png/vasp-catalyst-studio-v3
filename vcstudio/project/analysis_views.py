...
def build_kinetic_view(
    ...
    for index, raw in enumerate(result_points):
        ...
        points.append({
            ...
            "drc": metric(raw.get("drc"), "step_id"),
            "dsc": metric(raw.get("dsc"), "step_id"),
            "reaction_order": metric(raw.get("reaction_order"), "species_id"),
...
__all__ = [
    ...
    "build_comparison_view", "build_kinetic_view",
]
